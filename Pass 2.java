...
try
{
br=new BufferedReader(new FileReader("C:/Users/Acer/Desktop/SPOS Programs/Spos Additional/IM.txt"));
...
{
br1=new BufferedReader(new FileReader("C:/Users/admin/Documents/SPOS_code/Exp1/ST.txt"));
br2=new BufferedReader(new FileReader("C:/Users/Acer/Desktop/SPOS Programs/Spos Additional/LT.txt"));
if(t.charAt(0)=='S')
{
char a;
int aa;
